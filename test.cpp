...
int main()
{
	...
	// add light
	DirLight* light = new DirLight(glm::vec3(1.0f, 1.0f, 0.7f), glm::vec3(0.0f, 0.0f, 0.0f), glm::normalize(glm::vec3(0.2f, 0.5f, -1.0f)), 0.5f, false);
	...
	unsigned int texture = loadTexture("res/grass.png");
